...
export const AadhaarIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <rect x="2" y="2" width="20" height="20" rx="2" opacity="0.2" />
    <text x="12" y="15" textAnchor="middle" fontSize="10" fontWeight="bold" fill="currentColor">
      AA
    </text>
  </svg>
)
...
export const CarIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="M4 14h16v-8c0-1-1-2-2-2H6c-1 0-2 1-2 2v8z" />
...
export const ClipboardIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
