...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="min-h-screen flex items-center pt-20 pb-20 bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                <button className="px-8 py-3 border-2 border-[#1E73BE] text-[#1E73BE] rounded-lg hover:bg-blue-50 transition font-semibold">
                  Contact Us
                </button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Licensed Operators</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Claim Assistance</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-[#0D1B2A] mb-12">Documentation & Digital Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Professional government services</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Insurance Services */}
          <div>
            <h2 className="text-3xl font-bold text-[#0D1B2A] mb-12">Insurance Services</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-[#0D1B2A] mb-6">About Manhar Total Solution</h2>
